...
| 🧭 **技能管理** | 技能按 **9 大分类**自动归类；中文简介；GitHub / skills.sh 仓库链接一键安装；移除双重确认；分类浏览；**一键生成总路由技能（skill-router）**，在任何 Agent 中按情境推荐共享库技能 | 向导 [3] |
...
| [3] 技能管理 | **a** 技能清单（按 9 大分类分组，含中文简介）· **b** 从 GitHub / skills.sh 仓库链接安装 · **c** 移除（双重确认）· **d** 按分类浏览 · **e** 生成/刷新总路由技能（skill-router） |

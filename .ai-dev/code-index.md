...
- 生成时间：2026-09-20 01:50（手工增量校正：新增 translate-skill-intro.ps1 与 lib\translate.ps1，刷新 install-skill / setup-wizard / README / docs 行数）
- 源码文件：22 个，合计约 4656 行
...
- `README.md` (345 行) — Agent Skills 共享方案（统一目录 + 目录联接）  <!-- README.md -->
### config

- `agents.example.json` (29 行) — Agent 路径配置模板（24 项预设，含 Marvis 占位）  <!-- config/agents.example.json -->
### docs

- `01-architecture.md` (133 行) — 01 · 方案详解（架构与原理）  <!-- docs/01-architecture.md -->
- `02-agent-path-reference.md` (113 行) — 02 · 主流 Agent 技能目录速查表  <!-- docs/02-agent-path-reference.md -->
- `03-setup-guide.md` (202 行) — 03 · 完整搭建指南  <!-- docs/03-setup-guide.md -->
...
- `install-skill.ps1` (235 行) — requires -Version 5.1  <!-- scripts/install-skill.ps1 -->
...
- `setup-wizard.ps1` (1127 行) — requires -Version 5.1  <!-- scripts/setup-wizard.ps1 -->
- `setup.ps1` (173 行) — requires -Version 5.1  <!-- scripts/setup.ps1 -->
- `translate-skill-intro.ps1` (210 行) — requires -Version 5.1  <!-- scripts/translate-skill-intro.ps1 -->
...
- `translate.ps1` (157 行) — translate.ps1 — 技能简介翻译 + SKILL.md frontmatter 解析 被 install-skill.ps1 / translate-skill-intro.ps1 共用（dot-source 加载）  <!-- scripts/lib/translate.ps1 -->
